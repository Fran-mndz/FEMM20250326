...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Data Source=M01-CII;Initial Catalog=Test20250324DB;Integrated Security=True;Encrypt=False");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Brand>(entity =>
        {
            entity.HasKey(e => e.Id).HasName("PK__Brands__3214EC070E891CD2");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Products__3214EC077AE10880");
        ...
        {
            entity.HasKey(e => e.Id).HasName("PK__Users__3214EC078D015EC3");

            entity.HasIndex(e => e.Email, "UQ__Users__A9D10534536A8214").IsUnique();
